...
function ResumeDisplay({ data }) {
  ...
  const renderExperience = (experiences, title = "Experience") => (
    <div className="mb-8" style={{ fontFamily: 'Palatino Linotype' }}>
      <h2 className="text-xl font-bold  border-black mb-4">{title}</h2>
  ...
  const renderEducation = () => (
    <div className="mb-8" style={{ fontFamily: 'Palatino Linotype' }}>
      <h2 className="text-xl font-bold  border-black mb-4">Education</h2>
  ...
  const renderSkills = () => (
    <div className="mb-8" style={{ fontFamily: 'Palatino Linotype' }}>
      <h2 className="text-xl font-bold  border-black mb-4">Key Skills</h2>
      <ul className="list-disc pl-5 space-y-1">
  ...
  const renderInterests = () => (
    data.interests?.length > 0 && (
      <div className="mb-8" style={{ fontFamily: 'Palatino Linotype' }}>
        <h2 className="text-xl font-bold  border-black mb-4">Interests</h2>
        <ul className="list-disc pl-5 space-y-1">
  ...
  const renderPages = () => {
    return (
      <div className="space-y-8" style={{ fontFamily: 'Palatino Linotype' }}>
        {/* Page 1 */}
        <div className="page-break-after page-container">
          {renderLogos()}
          {renderHeader()}
          <div className="mb-8">
            <h2 className="text-xl font-bold  border-black mb-2">Profile</h2>
            <p className="text-justify">{data.profile}</p>
          </div>
          {renderExperience(data.experience.slice(0, 2))}
          <div className="page-footer" style={{ fontFamily: 'Palatino Linotype' }}>
        ...
        {data.experience.length > 2 && (
          <div className="page-break-after page-container">
            {renderLogos()}
            {renderExperience(data.experience.slice(2), "Experience (cont.)")}
            {renderEducation()}
            {renderSkills()}
            {renderInterests()}
            <div className="page-footer" style={{ fontFamily: 'Palatino Linotype' }}>
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div ref={resumeRef} className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
        <div className="p-8" style={{ fontFamily: 'Palatino Linotype' }}>
          {renderPages()}
        </div>
